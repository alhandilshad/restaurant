  ...
  return (
    ...
    <div id='bg-main2'>
       <div className='flex justify-center items-center gap-96'>
        ...
        <div>
            <h1 className='text-[44px] text-white font-bold text-center pt-5'>Pasta</h1>
        </div>
    </div>
    ...
    <div className='w-[100%] h-[160vh] bg-[#251e1c]'>
        <div className='flex text-[15px] justify-center items-center text-white pt-24'>
            ...
            <Link href="/Pasta" className='bg-[#738373] text-white transition-[o.6s] text-center' id='links'>PASTA</Link>
        ...
        <div className='flex justify-center items-center gap-10 mt-24'>
            <div className='text-center'>
              <img src='/pasta1.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>115 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Buckwheat noodles with mushroom mix</p>
            </div>
            <div className='text-center'>
              <img src='/pasta2.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>190 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Lasagna with veal</p>
            </div>
            <div className='text-center'>
              <img src='/pasta3.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>230 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Lasagna with tuna</p>
            </div>
        </div>
        <div className='flex justify-center items-center gap-10 mt-24'>
            <div className='text-center'>
              <img src='/pasta4.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>140 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Pasta Bolognaise</p>
            </div>
            <div className='text-center'>
              <img src='/pasta5.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>240 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Risotto black with shrimps</p>
            </div>
            <div className='text-center'>
              <img src='/pasta6.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>140 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Ravioli with tuna and coconut sauce</p>
            </div>
        </div>
    </div>
