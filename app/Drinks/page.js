...
const page = () => {
  return (
    ...
    <div id='bg-main2'>
        ...
        <div>
            <h1 className='text-[44px] text-white font-bold text-center pt-5'>Drinks</h1>
        </div>
    </div>
    ...
    <div className='w-[100%] h-[160vh] bg-[#251e1c]'>
        <div className='flex text-[15px] justify-center items-center text-white pt-24'>
            ...
            <Link href="/Drinks" className='bg-[#738373] text-white transition-[o.6s] text-center' id='links'>DRINKS</Link>
        </div>
        <div className='flex justify-center items-center gap-10 mt-24'>
            <div className='text-center'>
              <img src='/drink1.jpg' width={400} height={300}></img>
              <p className='text-white pt-3 text-[15px]'>Soft Drinks</p>
            </div>
            <div className='text-center'>
              <img src='/drink2.jpg' width={400} height={300}></img>
              <p className='text-white pt-3 text-[15px]'>Hot Drinks</p>
            </div>
            <div className='text-center'>
              <img src='/drink3.jpg' width={400} height={300}></img>
              <p className='text-white pt-3 text-[15px]'>Freshes</p>
            </div>
        </div>
        <div className='flex justify-start items-center mt-20 ml-[120px]'>
            <div className='text-center'>
              <img src='/drink4.jpg' width={400} height={300}></img>
              <p className='text-white pt-3 text-[15px]'>Beverages</p>
            </div>
        </div>
    </div>
