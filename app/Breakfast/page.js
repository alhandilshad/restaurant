...
const page = () => {
  return (
    ...
    <div id='bg-main2'>
        ...
        <div>
            <h1 className='text-[44px] text-white font-bold text-center pt-5'>Breakfast</h1>
        </div>
    </div>
    ...
    <div className='w-[100%] h-[160vh] bg-[#251e1c]'>
        <div className='flex text-[15px] justify-center items-center text-white pt-24'>
            <Link href="/Breakfast" className='bg-[#738373] text-white transition-[o.6s] text-center' id='links'>BREAKFAST</Link>
        ...
        <div className='flex justify-center items-center gap-10 mt-24'>
            <div className='text-center'>
              <img src='/breakfast1.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>80 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Classic omlet with chiken fillet and mozzarella</p>
            </div>
            <div className='text-center'>
              <img src='/breakfast2.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>90 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Cottage cheese pancakes with coconut and vanila sauce</p>
            </div>
            <div className='text-center'>
              <img src='/breakfast3.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>105 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Shakshuka</p>
            </div>
        </div>
        <div className='flex justify-start items-center mt-20 ml-[120px] gap-10'>
            <div className='text-center'>
              <img src='/breakfast4.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>140 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Eggs benedict with bacon and Bechamel sauce</p>
            </div>
            <div className='text-center'>
              <img src='/breakfast5.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>150 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Egg panne with salmon and zucchini pancake</p>
            </div>
        </div>
    </div>
