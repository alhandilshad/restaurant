  ...
  return (
    ...
    <div id='bg-main2'>
       <div className='flex justify-center items-center gap-96'>
        ...
        <div>
            <h1 className='text-[44px] text-white font-bold text-center pt-5'>Fish & SeaFoods</h1>
        </div>
    </div>
    ...
    <div className='w-[100%] h-[160vh] bg-[#251e1c]'>
        <div className='flex text-[15px] justify-center items-center text-white pt-24'>
            ...
            <Link href="/Fish" className='bg-[#738373] text-white transition-[o.6s] text-center' id='links'>FISH & SEAFOODS</Link>
        ...
        <div className='flex justify-center items-center gap-10 mt-24'>
            <div className='text-center'>
              <img src='/fish1.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>320 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Salmon with sweet potato and hollandaise sauce</p>
            </div>
            <div className='text-center'>
              <img src='/fish2.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>190 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Perch fillets with cauliflower and brussels sprouts</p>
            </div>
            <div className='text-center'>
              <img src='/fish3.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>350 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Tuna tataki in sesame with quinoa and spinach</p>
            </div>
        </div>
        <div className='flex justify-start items-center mt-20 ml-[120px]'>
            <div className='text-center'>
              <img src='/fish4.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>280 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Dorado fillet with spinach mashed potatoes and shrimps</p>
            </div>
        </div>
    </div>
