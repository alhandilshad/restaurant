...
const page = () => {
  return (
    ...
    <div id='bg-main2'>
        ...
        <div>
            <h1 className='text-[44px] text-white font-bold text-center pt-5'>Salads</h1>
        </div>
    </div>
    ...
    <div className='w-[100%] h-[160vh] bg-[#251e1c]'>
        <div className='flex text-[15px] justify-center items-center text-white pt-24'>
            ...
            <Link href="/Salads" className='bg-[#738373] text-white transition-[o.6s] text-center' id='links'>SALADS</Link>
        ...
        <div className='flex justify-center items-center gap-10 mt-24'>
            <div className='text-center'>
              <img src='/salad1.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>140 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Salad with halumi cheesse and vegetables</p>
            </div>
            <div className='text-center'>
              <img src='/salad2.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>185 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Salad with shrimps and avocado</p>
            </div>
            <div className='text-center'>
              <img src='/salad3.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>120 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Salad with chicken fillet, parmesan and cherry tomatoes</p>
            </div>
        </div>
        <div className='flex justify-start items-center mt-20 ml-[120px] gap-10'>
            <div className='text-center'>
              <img src='/salad4.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>170 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Salad with roast beef, rucola and vegetables</p>
            </div>
            <div className='text-center'>
              <img src='/salad5.jpg' width={400} height={300}></img>
              <span className='bg-white py-1 px-7 font-semibold text-xl'>205 Rs.</span>
              <p className='text-white pt-3 text-[15px]'>Salad with salmon and quail eggs</p>
            </div>
        </div>
    </div>
